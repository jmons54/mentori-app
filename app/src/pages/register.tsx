...
export function Register() {
  ...
  return (
    <div className="max-w-md mx-auto mt-20 px-6 py-8 bg-white rounded shadow-md text-center">
      ...
      {success ? (
        <>
          <div className="bg-greeb-100 text-green-700 border border-green-400 rounded px-4 py-2 mb-4 text-sm">
            Inscription réussie !
          </div>
          <button
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between">
            ...
            {step === steps.length - 1 && (
              <button
                type="submit"
                disabled={Boolean(!isFormValid() || errorMessage)}
